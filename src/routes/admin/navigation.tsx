    ...
    <div className="space-y-6 max-w-4xl">
      ...
      <div className="rounded-xl border border-border bg-surface/60 p-6">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-semibold text-foreground">Header & Footer Links</h2>
          <button
            onClick={addLink}
            className="flex items-center gap-2 rounded-lg bg-surface-raised px-3 py-1.5 text-xs font-semibold text-muted-foreground hover:bg-surface-raised"
          >
              ...
              <div key={index} className="flex items-center gap-3">
                ...
                <div className="flex-1">
                  <input
                    ...
                    className="w-full rounded border border-border bg-background p-2 text-sm text-foreground font-mono"
                    required
                  />
                </div>
                <button
