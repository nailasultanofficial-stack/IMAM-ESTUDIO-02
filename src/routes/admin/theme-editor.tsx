...
function AdminThemeEditorPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        <p className="text-xs font-mono text-muted-foreground py-8">Loading homepage sections...</p>
      ) : (
        <div className="grid gap-6 lg:grid-cols-12">
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="rounded p-1.5 text-muted-foreground hover:bg-surface-raised hover:text-foreground disabled:opacity-30"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1 rounded bg-surface-raised px-3 py-1.5 text-xs font-medium text-foreground hover:bg-surface-raised"
                  >
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-6 rounded-xl border border-border bg-surface/60 p-6">
              <h2 className="text-sm font-semibold text-foreground font-mono uppercase tracking-wider mb-4">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full font-mono text-xs rounded border border-border bg-background p-3 text-primary focus:outline-none"
                    />
                  </div>
                  ...
                  <div className="flex justify-end gap-2 pt-3 border-t border-border">
                    ...
                    <button
                      ...
                      disabled={saving}
                      className="flex items-center gap-1.5 rounded bg-primary px-4 py-1.5 text-xs font-semibold text-zinc-950 hover:bg-primary"
                    >
