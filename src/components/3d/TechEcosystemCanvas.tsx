...
const TECH_NODES: TechNode[] = [
  ...
  },
  {
    ...
    name: "PgVector & RAG",
    category: "AI & Data",
    description: "Vector embedding storage & hybrid semantic search retrieval engines.",
  ...
  },
  {
    ...
    category: "AI & Data",
    description: "Automated document parsing, multi-step LLM agents & dispatch logic.",
