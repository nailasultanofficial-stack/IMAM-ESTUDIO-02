...
export function ServiceCard({ service, index }: { service: Service; index?: number }) {
  return (
    ...
    >
      <div className="flex h-full flex-col rounded-xl border border-border/60 bg-surface/30 p-4 md:p-5 transition-all duration-200 hover:border-primary/30 hover:bg-surface/70 hover:shadow-md hover:shadow-primary/5">
        {/* Number + Category */}
