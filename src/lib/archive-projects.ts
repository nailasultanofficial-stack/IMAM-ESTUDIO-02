...
export const ARCHIVE_GIG_PROJECTS: Project[] = [
  ...
  {
    id: "archive-proj-1",
    slug: "archive-custom-build-your-own-box-configurator-1",
    title: "Custom Build-Your-Own Box Configurator",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: A premium nuts and dried fruit brand needed to replace a basic, static                         custom tray page with an interactiv...",
    description:
  ...
  {
    id: "archive-proj-5",
    slug: "archive-product-page-ui-mobile-gallery-sticky-at-5",
    title: "Product Page UI: Mobile Gallery & Sticky ATC",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals                         A sports nutrition brand needed to boost mobile conversion rates (CRO). The goal: a frictionless           ...",
    description:
  ...
  {
    id: "archive-proj-6",
    slug: "archive-urgent-shopify-launch-support-bug-fixes-6",
    title: "Urgent Shopify Launch Support & Bug Fixes",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      'Client &amp; Goals                         The client was preparing for a highly anticipated brand launch for their store ("ASHA") but was          ...',
    description:
  ...
  {
    id: "archive-proj-7",
    slug: "archive-high-converting-b2b-lead-gen-funnel-in-f-7",
    title: "High-Converting B2B Lead Gen Funnel in Framer",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "The Client &amp; Goal:                         I partnered with noll.media, a marketing agency targeting the German industrial and                    ...",
    description:
  ...
  {
    id: "archive-proj-8",
    slug: "archive-custom-shopify-page-templates-8",
    title: "Custom Shopify Page Templates",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: A premium health and wellness brand needed to elevate their store’s UX to                         match high-end competitors. Thei...",
    description:
  ...
  {
    id: "archive-proj-9",
    slug: "archive-high-converting-product-page-ux-9",
    title: "High-Converting Product Page UX",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: The client was driving expensive paid traffic to their product pages but                         experiencing a low conversion rat...",
    description:
  ...
  {
    id: "archive-proj-10",
    slug: "archive-dynamic-shopify-mega-menu-build-10",
    title: "Dynamic Shopify Mega Menu Build",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: An e-commerce brand needed a robust, visually appealing way to showcase                         their expanding product lines dire...",
    description:
  ...
  {
    id: "archive-proj-11",
    slug: "archive-mobile-ux-audit-cro-sprints-11",
    title: "Mobile UX Audit & CRO Sprints",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: A high-volume Shopify store was suffering from an unsustainable Cost Per                         Acquisition (CPA) and low convers...",
    description:
  ...
  {
    id: "archive-proj-12",
    slug: "archive-fix-shopify-meta-lead-pixel-bug-12",
    title: "Fix Shopify Meta Lead Pixel Bug",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals:                         I worked with an up-and-coming Shopify apparel brand running Facebook (Meta) Ads to collect SMS           ...",
    description:
  ...
  {
    id: "archive-proj-13",
    slug: "archive-amazon-style-product-page-pdp-redesign-13",
    title: "Amazon-Style Product Page (PDP) Redesign",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: An expanding e-commerce food brand wanted to overhaul their Product Detail                         Pages (PDP) to match the high-c...",
    description:
  ...
  {
    id: "archive-proj-14",
    slug: "archive-custom-responsive-category-navigation-ui-14",
    title: "Custom Responsive Category Navigation UI",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: A retail brand with a growing catalog needed to upgrade their homepage and                         collection pages. Their default...",
    description:
  ...
  {
    id: "archive-proj-15",
    slug: "archive-advanced-checkout-shipping-logic-15",
    title: "Advanced Checkout & Shipping Logic",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: An established e-commerce store wanted to optimize their checkout shipping                         options. They needed to maintai...",
    description:
  ...
  {
    id: "archive-proj-18",
    slug: "archive-custom-shopify-sections-ui-fixes-18",
    title: "Custom Shopify Sections & UI Fixes",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "The client, an e-commerce brand, needed specific UI enhancements for their Shopify store. While                         they loved their mobile layout...",
    description:
  ...
  {
    id: "archive-proj-21",
    slug: "archive-custom-shopify-countdown-lead-gen-21",
    title: "Custom Shopify Countdown & Lead Gen",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "My client, a growing streetwear brand, needed a high-converting, fully customizable countdown                         timer combined with a newsletter...",
    description:
  ...
  {
    id: "archive-proj-22",
    slug: "archive-dynamic-css-highlight-marker-for-sales-22",
    title: "Dynamic CSS Highlight Marker for Sales",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "The client wanted a visually striking way to highlight specific elements, such as sale prices                         and navigation menus, mimicking ...",
    description:
  ...
  {
    id: "archive-proj-24",
    slug: "archive-smart-variant-swatches-inventory-ui-24",
    title: "Smart Variant Swatches & Inventory UI",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "The client needed an advanced product page UI to handle complex color and size variations                         without relying on third-party apps ...",
    description:
      "The client needed an advanced product page UI to handle complex color and size variations                         without relying on third-party apps that slow down the site. They requested automatic 50/50                         split-color swatches (e.g., black/yellow) and smart sold-out states where unavailable sizes are                         visually crossed out, rather than greying out the entire product image. I utilized advanced                         Liquid architecture and custom CSS to automatically read variant color names and generate                         perfect half-and-half swatches dynamically. I also implemented smart inventory logic to visually                         strike through sold-out sizes, providing a flawless, app-free user experience that directly                         improved their conversion flow.",
    featured_image:
  ...
  {
    id: "archive-proj-25",
    slug: "archive-dynamic-shopify-pricing-cards-ui-25",
    title: "Dynamic Shopify Pricing Cards UI",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: My client, a GPS tracking tech brand, needed a custom pricing section to                         showcase their hardware subscript...",
    description:
  ...
  {
    id: "archive-proj-26",
    slug: "archive-2-step-shopify-onboarding-flow-26",
    title: "2-Step Shopify Onboarding Flow",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: Following the successful delivery of a custom pricing section, the client                         requested a more advanced user j...",
    description:
  ...
  {
    id: "archive-proj-30",
    slug: "archive-advanced-gamified-cart-drawer-upsell-30",
    title: "Advanced Gamified Cart Drawer Upsell",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "The Client &amp; Goal: The client wanted to replace a clunky, expensive third-party app with a                         fully custom Cart Drawer to han...",
    description:
      'The Client &amp; Goal: The client wanted to replace a clunky, expensive third-party app with a                         fully custom Cart Drawer to handle free gifts, upsells, and urgency drivers cleanly within their                         theme.                          The Challenge: Shopify only allows one automatic discount at a time. The client already had an                         automatic tiered discount running, which conflicted with the "Free Gift at €75" functionality I                         built, causing the 100% discount not to apply.                          The Solution: I engineered a smart workaround using a "€0 Gift Strategy". I created hidden €0                         products that do not show up in store searches or collections. The custom cart drawer calculates                         the €75 threshold via an animated progress bar. Once unlocked, the customer can choose from 3                         premium gifts. I also integrated a swipeable "You Might Also Like" product carousel and a live                         countdown timer in the announcement bar. This saved the client monthly app fees while                         dramatically improving the checkout UX.',
    featured_image:
  ...
  {
    id: "archive-proj-32",
    slug: "archive-shopify-custom-pricing-mobile-grid-optim-32",
    title: "Shopify Custom Pricing & Mobile Grid Optimization",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals:                         Honest Supplements, a growing health and fitness brand, needed to synchronize their dynamic               ...",
    description:
  ...
  {
    id: "archive-proj-33",
    slug: "archive-dynamic-custom-payment-icons-33",
    title: "Dynamic Custom Payment Icons",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "The Goal: The client needed to increase trust and conversions on their supplement store                         (Vibefuel) by displaying localized pay...",
    description:
      'The Goal: The client needed to increase trust and conversions on their supplement store                         (Vibefuel) by displaying localized payment icons (iDEAL, Bancontact, Klarna, etc.) directly                         below the "Add to Cart" button.The Challenge: They didn\'t want to use a heavy app, and they                         needed the ability to easily turn specific icons on and off without touching the code.The                         Solution: I developed a lightweight, custom Shopify Liquid snippet and integrated it seamlessly                         into their product template. I added custom schema settings to the theme editor, allowing the                         client to toggle individual payment icons dynamically. This resulted in a cleaner UI, improved                         social proof, and a 100% editor-friendly setup.',
    featured_image:
  ...
  {
    id: "archive-proj-37",
    slug: "archive-shopify-homepage-redesign-theme-setup-37",
    title: "Shopify Homepage Redesign & Theme Setup",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client: A handmade furniture business owner launching their brand.                         Goals: Restore the site after AI-generated code broke the l...",
    description:
      'Client: A handmade furniture business owner launching their brand.                         Goals: Restore the site after AI-generated code broke the layout, and visually style the                         Homepage to reflect a premium, rustic aesthetic.                         Challenges: The client had zero coding experience and was stuck in "coding hell." The site                         needed to look custom but remain 100% manageable by a non-technical user.                         Solutions: I cleaned up the broken code and rebuilt the homepage using native, customizable                         Shopify sections. I integrated custom typography, designed a footer email capture, linked social                         media placecards, and built a dynamic quote header. Most importantly, I moved all customization                         options into the Shopify Theme Editor so the client could manage text, fonts, and images                         entirely code-free.',
    featured_image:
  ...
  {
    id: "archive-proj-41",
    slug: "archive-luxury-shopify-redesign-complex-feature--41",
    title: "Luxury Shopify Redesign & Complex Feature Build",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "This project involved a complete overhaul of the client's Shopify store, transforming it from a                         basic setup to a high-end, bra...",
    description:
  ...
  {
    id: "archive-proj-44",
    slug: "archive-infinite-shopify-testimonial-slider-44",
    title: "Infinite Shopify Testimonial Slider",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "The client, running a custom neon sign brand, needed a premium review slider to build trust and                         match the aesthetic of a high-...",
    description:
  ...
  {
    id: "archive-proj-46",
    slug: "archive-high-converting-e-commerce-footer-46",
    title: "High-Converting E-commerce Footer",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "The client needed a complete overhaul of their site's footer to improve secondary navigation,                         integrate lead capture, and esta...",
    description:
  ...
  {
    id: "archive-proj-51",
    slug: "archive-shopify-store-monthly-maintenance-seo-51",
    title: "Shopify Store Monthly Maintenance & SEO",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "After a successful initial redesign, the client required ongoing technical support to ensure                         their wholesale store remained fa...",
    description:
  ...
  {
    id: "archive-proj-54",
    slug: "archive-shopify-gamification-xp-system-54",
    title: "Shopify Gamification & XP System",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "My client, the founder of RC Arsenal, wanted to gamify his e-commerce store to increase                         community engagement. His goal was to ...",
    description:
      'My client, the founder of RC Arsenal, wanted to gamify his e-commerce store to increase                         community engagement. His goal was to introduce an XP system, badges, and a custom "Garage"                         profile for users.                          A major challenge was the initial reliance on third-party apps like Gameball, which complicated                         the user flow and added unnecessary bloat. I resolved this by migrating the entire logic to                         native Shopify Metafields. I developed a complete frontend architecture, including a live                         section switcher and automated the customer onboarding process using Shopify Flow. Now, when a                         user signs up, their XP, rank, tier, and avatar metafields are initialized automatically without                         admin intervention. The result is a highly engaging, lightweight, and completely custom                         gamification loop built directly into the Shopify theme.',
    featured_image:
  ...
  {
    id: "archive-proj-58",
    slug: "archive-custom-shopify-ajax-mini-cart-58",
    title: "Custom Shopify AJAX Mini Cart",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: The client, a premium jewelry brand (BijouxBee), wanted to replace their                         bulky default Shopify cart page w...",
    description:
  ...
  {
    id: "archive-proj-60",
    slug: "archive-custom-shopify-product-page-footer-60",
    title: "Custom Shopify Product Page & Footer",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "The client needed specific UI/UX updates to modernize their Shopify product pages and footer to                         improve the overall shopping e...",
    description:
      'The client needed specific UI/UX updates to modernize their Shopify product pages and footer to                         improve the overall shopping experience.                          Goals: Create a custom quantity selector, integrate a "You May Also Like" cross-sell section,                         and restructure the footer layout.                         Challenges: Ensuring the custom CSS and Liquid code blended perfectly with their existing theme                         without breaking mobile responsiveness.                         Solution: I wrote clean, lightweight HTML, CSS, and Shopify Liquid to build out the custom                         sections. I ensured the cross-sell section was dynamically linked to product recommendations and                         optimized the footer for clean navigation and trust-building.',
    featured_image:
  ...
  {
    id: "archive-proj-61",
    slug: "archive-shopify-mobile-filter-ux-optimization-61",
    title: "Shopify Mobile Filter UX Optimization",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Mobile traffic accounts for the majority of e-commerce sales, and this client needed a smoother,                         more intuitive filtering syst...",
    description:
      "Mobile traffic accounts for the majority of e-commerce sales, and this client needed a smoother,                         more intuitive filtering system for their mobile users.                          Goals: Redesign the default mobile filter into a modern, clean, slide-out UI.                         Challenges: Mobile real estate is limited, so the filter needed to be easily accessible without                         overlapping critical product information.                         Solution: I developed a custom mobile-first layout using CSS and JavaScript. I implemented a                         seamless slide-out drawer style for the filters, ensuring touch targets were appropriately sized                         for thumbs, making it significantly easier for shoppers to find what they want on smaller                         screens.",
    featured_image:
  ...
  {
    id: "archive-proj-62",
    slug: "archive-shopify-slider-ui-fix-interactivity-62",
    title: "Shopify Slider UI Fix & Interactivity",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "The client was experiencing a critical UI bug on their Shopify store where their product media                         slider had become completely un...",
    description:
  ...
  {
    id: "archive-proj-63",
    slug: "archive-shopify-typography-custom-section-design-63",
    title: "Shopify Typography & Custom Section Design",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals:                         A high-end lifestyle brand approached The Imam Studio to elevate their online storefront's                ...",
    description:
  ...
  {
    id: "archive-proj-64",
    slug: "archive-multi-platform-custom-coding-showcase-64",
    title: "Multi-Platform Custom Coding Showcase",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "The Client &amp; Goals: A prominent client required advanced, custom front-end development                         across three distinct brands and pl...",
    description:
  ...
  {
    id: "archive-proj-66",
    slug: "archive-smooth-shopify-cart-drawer-ux-fix-66",
    title: "Smooth Shopify Cart Drawer UX Fix",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "My client, running the wellness brand Relaxvest, needed a high-converting, premium feel for                         their Shopify cart. Their existing...",
    description:
  ...
  {
    id: "archive-proj-67",
    slug: "archive-custom-shopify-mega-menu-ui-67",
    title: "Custom Shopify Mega Menu UI",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: Flawless Jewels is a growing brand that needed a more intuitive and visually                         engaging way for customers to...",
    description:
  ...
  {
    id: "archive-proj-68",
    slug: "archive-custom-shopify-responsive-pop-up-form-68",
    title: "Custom Shopify Responsive Pop-Up Form",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: The client needed a customized, brand-aligned pop-up form for their Shopify                         store (Naialea) to capture lea...",
    description:
  ...
  {
    id: "archive-proj-69",
    slug: "archive-dynamic-shopify-video-testimonial-slider-69",
    title: "Dynamic Shopify Video Testimonial Slider",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client Goal:                         The client wanted to elevate their Shopify product page by integrating a high-converting,                        ...",
    description:
  ...
  {
    id: "archive-proj-70",
    slug: "archive-custom-shopify-tabs-style-measurements-70",
    title: "Custom Shopify Tabs: Style & Measurements",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals:                         The client, an online apparel brand, needed to upgrade their product page to handle complex,              ...",
    description:
  ...
  {
    id: "archive-proj-72",
    slug: "archive-custom-shopify-image-marquee-slider-72",
    title: "Custom Shopify Image Marquee Slider",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals: An e-commerce brand owner needed a highly engaging, continuous-scroll image                         slider for their product pages...",
    description:
  ...
  {
    id: "archive-proj-73",
    slug: "archive-custom-subscription-buy-box-variants-73",
    title: "Custom Subscription Buy Box & Variants",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals:                         I worked with a premium pet nutrition brand that needed to upgrade their product pages to                 ...",
    description:
  ...
  {
    id: "archive-proj-74",
    slug: "archive-custom-product-page-data-collection-form-74",
    title: "Custom Product Page Data Collection Form",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals:                         A tailored pet nutrition brand required a way to collect highly specific data about their                 ...",
    description:
  ...
  {
    id: "archive-proj-75",
    slug: "archive-custom-shopify-trustpilot-section-75",
    title: "Custom Shopify Trustpilot Section",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "My client, an established Shopify developer and agency owner, needed a reliable partner to                         handle overflow development work. T...",
    description:
  ...
  {
    id: "archive-proj-76",
    slug: "archive-custom-shopify-product-page-ui-ux-76",
    title: "Custom Shopify Product Page UI/UX",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals:                         My client, a German health and wellness brand, wanted to completely overhaul their Shopify                ...",
    description:
  ...
  {
    id: "archive-proj-77",
    slug: "archive-custom-jewelry-featured-collection-77",
    title: "Custom Jewelry Featured Collection",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      'The client, a premium jewelry brand, needed a highly customized "Featured Collection" section                         flawlessly integrated into the...',
    description:
  ...
  {
    id: "archive-proj-78",
    slug: "archive-dynamic-shopify-gifting-form-78",
    title: "Dynamic Shopify Gifting Form",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals:                         My client runs a specialized premium gifting website and needed a seamless way for buyers to              ...",
    description:
  ...
  {
    id: "archive-proj-79",
    slug: "archive-shopify-section-migration-ui-setup-79",
    title: "Shopify Section Migration & UI Setup",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      'An e-commerce brand migrating to the premium "Olivia" Shopify theme needed to seamlessly                         transfer six custom, conversion-cri...',
    description:
  ...
  {
    id: "archive-proj-80",
    slug: "archive-shopify-custom-ui-texturing-80",
    title: "Shopify Custom UI Texturing",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals:                         A boutique Shopify brand approached me to elevate their store's visual identity. They wanted to           ...",
    description:
  ...
  {
    id: "archive-proj-81",
    slug: "archive-premium-shopify-scroll-animation-section-81",
    title: "Premium Shopify Scroll Animation Sections",
    category: "Shopify / Commerce",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals                         The client was looking to elevate their Shopify store (running the Concept theme) by introducing           ...",
    description:
  ...
  {
    id: "archive-proj-82",
    slug: "archive-custom-shopify-product-section-ui-82",
    title: "Custom Shopify Product Section UI",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "Client &amp; Goals:                         My client, an e-commerce brand, needed a high-converting upgrade to their Shopify Dawn theme's            ...",
    description:
  ...
  {
    id: "archive-proj-85",
    slug: "archive-dynamic-geo-targeted-shipping-localizati-85",
    title: "Dynamic Geo-Targeted Shipping & Localization UI",
    category: "Web Engineering",
    project_type: "Engineering Work",
    collaboration_type: "Engineering Contribution",
    short_description:
      "The client needed a way to increase trust and transparency for international visitors. The goal                         was to display a dynamic shipp...",
    description:
      "The client needed a way to increase trust and transparency for international visitors. The goal                         was to display a dynamic shipping message based on the visitor's location (e.g., \"Free Shipping                         to U.A.E.\") that also integrated perfectly with the Shopify 'Translate &amp; Adapt' app.                          Challenge: Ensuring the geo-location detection and flag display didn't conflict with existing                         theme scripts, and ensuring all text strings were fully translatable across multiple languages.                          Solution: I developed a custom Shopify liquid block with lightweight JavaScript. I used unique                         class naming to prevent style conflicts and ensured full compatibility with Shopify’s native                         localization API. This allowed the client to manage all translations through their existing                         dashboard seamlessly.",
    featured_image:
