...
- **Full-Stack Web Applications**: Production-grade React 19, Next.js SaaS apps, dashboards, and Supabase integration.
- **AI Automation & Agents**: Custom n8n AI workflows, intelligent agents, and automated business operations.
...
- **Database & Auth**: Supabase PostgreSQL (`zcihimfisgzpeeyhdnfq`) + Row-Level Security (RLS) + SECURITY DEFINER predicates
