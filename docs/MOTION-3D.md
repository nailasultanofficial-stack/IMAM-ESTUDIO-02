...
- `TechEcosystemCanvas.tsx`: Interactive spatial node matrix representing the 10 core engineering technologies (Shopify, Hydrogen, React 19, TypeScript, TanStack, Supabase, PgVector, OpenAI, TailwindCSS, Vercel).
